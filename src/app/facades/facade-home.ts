...
export const home = html`                         
                    ...
                    <div class="row" id="features">
                        <stn-card title="Control" class="column" height="35rem" icon="cube">
                            <ul>
                        ...
                        <stn-card title="Web Standards" class="column" height="35rem" icon="cube">
                            <p>Work with... not against the browser</p>
                        </stn-card>
                        <stn-card title="Modern JS" class="column" height="35rem" icon="cube">
                            <p>Code in Typescript and/or Javascript with all the latest features</p>
                        </stn-card>
                        </div>
                        <div class="row">
                        <stn-card title="Not a Framework!" class="column" height="35rem" icon="cube">
                            <p>A combination of the best tools, best practices, with standard setup</p>
                        </stn-card>
                        <stn-card title="Ready to Grow" class="column" height="35rem" icon="cube">
                            <p>Carefully avoid framework, cli, or any other lock-inh</p>
                        </stn-card>
                        <stn-card title="????" class="column" height="35rem" icon="cube">
                            <p>???</p>
                        </stn-card>
                    </div>
`;
